...
public class mit_frgMenuTienda extends Fragment {
    ...
    Button rt_MntndbtnPrvdr ,rt_StckbtnStck, rt_EdtDtsbtnEdtDts, rt_CmbrtndbtnCmbrtn, rt_AgrgtndbtnAgrgtnd;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rt_MntndbtnPrvdr = view.findViewById(R.id.rt_MntndbtnPrvdr);
        rt_StckbtnStck = view.findViewById(R.id.rt_StckbtnStck);
        ...
        rt_MntndbtnPrvdr.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_nav_mi_tienda_to_nav_menu_proveedor);
            }
        });

        rt_StckbtnStck.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_nav_menutienda_to_nav_ingreso_stock);
            }
        });
